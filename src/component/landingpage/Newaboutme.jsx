...
const Newaboutme = () => {
    ...
    <div id="main_newaboutme" name="main_newaboutme" className="min-w-[450px] md:h-[500px] xl:h-630 w-full md:w-full xl:w-full flex flex-col md:flex-row bg-hijauDAD7CD">
        ...
        <div id="hero_kiri"  className="  order-1 md:w-[35%] flex  pb-10 pt-10 md:py-0">
            <img src={pp} className=" mx-auto my-auto rounded-full w-[300px] h-[300px] sm:w-[350px] sm:h-[350px]
        ...
        <div id="hero_tengah" className=" order-2 md:w-[40%] flex flex-col pl-20 pr-20 pb-0 pt-0 xl:px-0 xl:pt-24 md:py-20 md:px-4  ">
            ...
            <p class="leading-relaxed text-heading4 md:leading-relaxed md:text-heading5 lg:text-heading5 lg:leading-relaxed xl:leading-relaxed xl:text-heading4 font-normal text-justify mt-8">“ I am David Alfian, i have a great interest in the UI/UX design Industry, now I'm doing an Internship on GAOTek Inc. as a UI/UX Designer. I am now focused on doing my best and learning as much as I can to improve my design, communication and collaboration skills ”</p>
