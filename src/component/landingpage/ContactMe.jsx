        ...
        <div>
            <div className=" min-w-[450px] md:w-full xl:w-full bg-hijauDAD7CD flex flex-col mt-[80px] px-10 md:pl-32 pt-12 pb-1 md:pr-32">
                ...
                <div className="flex-row">
                    <a href="mailto:davidalfiana@gmail.com"><FontAwesomeIcon icon={faEnvelope} /><span className="pl-5">davidalfiana@gmail.com</span></a>
                </div>
                <div className="flex-row">
                ...
                <div className="flex-row">
                    <a href="https://wa.me/+6285186825372"><FontAwesomeIcon icon={faWhatsapp} /><span className="pl-5">085186825372</span></a>
                </div> 
